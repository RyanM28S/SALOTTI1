...
function renderLogin() {
    main.innerHTML = `
        ...
        <div class="conteiner">
            ...
            <div>
                <button class="button-prof"><img src="../img/icone_inicial_header.png" alt="icone-para-login-professor">
                    <p>Professor</p>
                </button>
                <button class="button-aluno"><img src="../img/icone-pessoa.png" alt="icone-para-login-Alunos">
                    <p>Alunos</p>
                </button>
            </div>
            <form id="formLogin">
    ...
    formLogin.addEventListener("submit", function (event) {
        ...
        if (!dados.Email || !dados.Senha) {
            p.textContent = "Compete as informações"
        } else
